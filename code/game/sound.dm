...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("geiger") soundin = pick('sound/items/geiger/old/geiger1.ogg', 'sound/items/geiger/old/geiger2.ogg', 'sound/items/geiger/old/geiger3.ogg', 'sound/items/geiger/old/geiger4.ogg', 'sound/items/geiger/old/geiger5.ogg')
			if ("geiger_weak") soundin = pick('sound/items/geiger/old/geiger_weak1.ogg', 'sound/items/geiger/old/geiger_weak2.ogg', 'sound/items/geiger/old/geiger_weak3.ogg', 'sound/items/geiger/old/geiger_weak4.ogg')
